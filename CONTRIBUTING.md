# Contributing to MyGitHub

Welcome! Our community focuses on helping others and making MyGitHub the best it
...
If unique, [open an issue](https://github.com/webhippie/mygithub/issues)
and answer the questions so we can understand and reproduce the problematic
behavior.

The burden is on you to convince us that it is actually a bug in MyGitHub. This
...
Please be kind, remember that MyGitHub comes at no cost to you, and you're
getting free help.
...
resolving issues as you are able to. Thanks for making MyGitHub amazing!
...
Thanks for your help! MyGitHub would not be what it is today without your
contributions.
